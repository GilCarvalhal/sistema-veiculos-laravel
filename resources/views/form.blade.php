        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" enctype="multipart/form-data"
                    @if (isset($item)) action="{{ route('vehicle.update', $item->id) }}"
                    {!! method_field('PUT') !!}
                    @else
                    action="{{ route('vehicle.store') }}"> @endif
                    {!! csrf_field() !!}
            ...
            <div class="row">
                <div class="form-group col-sm-12 col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="vehicle_year" name="vehicle_year" autocomplete="off"
                        value="{{ isset($item) ? $item->vehicle_year : old('vehicle_year') }}">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-12 col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="contact_phone" name="contact_phone"
                        autocomplete="off" value="{{ isset($item) ? $item->contact_phone : old('contact_phone') }}">
                ...
                <div class="form-group col-sm-12 col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="contact_mail" name="contact_mail" autocomplete="off"
